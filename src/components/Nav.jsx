...
const Nav = () => {
    ...
    return (
        <div className="fixed grid grid-cols-3 place-items-center bg-[#ffffff] text-gray-900 h-[60px] rouded-b-[5px] shadow-lg hover:text-blue-600 w-screen z-10">
            <h2>Logo</h2>
            ...
            {isLogin ? <ProfileDropdown /> : <button></button>}
        </div>
    );
};
