...
const AddressModel = () => {
    const { isAddressModelVisible, setIsAddressModelVisible, editAddress } =
        useAddressContext();
    ...
    return (
        ...
        >
            ...
            <form
                action="POST"
                className="grid grid-rows-4 h-[80%] place-items-center"
            >
                <AddressInput
                    value={"Full Name(John Doe)"}
                    editValue={editAddress.name}
                    isRequired={true}
                />
                <div className="grid grid-cols-2 gap-4">
                    <AddressInput
                        value={"House Number"}
                        editValue={editAddress.houseNumber}
                        isRequired={true}
                    />
                    <AddressInput
                        value={"Street Name"}
                        editValue={editAddress.streetName}
                        isRequired={true}
                    />
                </div>
                <div className="grid grid-cols-2 gap-4">
                    <AddressInput
                        value={"Landmark"}
                        editValue={editAddress.landmark}
                        isRequired={true}
                    />
                    <AddressInput
                        value={"City"}
                        editValue={editAddress.city}
                        isRequired={true}
                    />
                </div>
                <div className="grid grid-cols-2 gap-4">
                    <AddressInput
                        value={"Pincode"}
                        editValue={editAddress.pincode}
                        isRequired={true}
                    />
                    <AddressInput
                        value={"Phone Number"}
                        editValue={editAddress.phoneNumber}
                        isRequired={true}
                    />
                </div>
